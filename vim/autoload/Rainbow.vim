...
"   endif
   ...
   if &bg == "dark"
    hi   hlLevel0 ctermfg=red         guifg=burlywood2
    hi   hlLevel1 ctermfg=yellow      guifg=White
    hi   hlLevel2 ctermfg=green       guifg=tan3
    hi   hlLevel3 ctermfg=cyan        guifg=burlywood4
    hi   hlLevel4 ctermfg=magenta     guifg=DarkGray
    hi   hlLevel5 ctermfg=red         guifg=SandyBrown
    hi   hlLevel6 ctermfg=yellow      guifg=gray92
    hi   hlLevel7 ctermfg=green       guifg=gray82
    hi   hlLevel8 ctermfg=cyan        guifg=gray72
    hi   hlLevel9 ctermfg=magenta     guifg=gray62
   else
    hi   hlLevel0 ctermfg=red         guifg=red3
    hi   hlLevel1 ctermfg=darkyellow  guifg=orangered3
    hi   hlLevel2 ctermfg=darkgreen   guifg=orange2
